...
class _BookScreenState extends ConsumerState<BookScreen>
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<BookDetailState>(bookDetailProvider(widget.bookId), (
      previous,
      next,
    ) {
    ...
    return Scaffold(
      body: detailState.isLoading && detailState.bookViewModel == null
          ? const Center(child: CircularProgressIndicator())
          : detailState.bookViewModel == null
          ? Center(child: Text(detailState.error ?? "Không tìm thấy sách"))
          : _buildMainContent(detailState.bookViewModel!, theme),
    );
  }

  Widget _buildMainContent(BookViewModel viewModel, ThemeData theme) {
    return Scaffold(
